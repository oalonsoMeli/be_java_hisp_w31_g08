...
public interface IProductController {
    ...
    @PostMapping("/post")
    ResponseEntity<String> createPost(@RequestBody @Valid PostDto postDto);
    ...
    @GetMapping("/followed/{userId}/list")
     ResponseEntity<?> getListOfPublicationsByUser(@PathVariable Integer userId,
    ...
    @PostMapping("/promo-post")
     ResponseEntity<String> createPromoPost(@RequestBody @Valid PromoPostDto promoPostDto);
    ...
    ResponseEntity<?> getQuantityOfProducts(@RequestParam Integer user_id);
   ...
   ResponseEntity<?> getPromotionalProductsFromSellers(@RequestParam(value="user_id") Integer userId);
    @Operation(
    ...
    @PostMapping("/valoration")
     ResponseEntity<?> valorateAPost(@RequestBody ValorationDTO valorationDTO);
    @Operation(
    ...
    @GetMapping("/{post_id}/valorations")
     ResponseEntity<?> getValorationsByPost(@PathVariable Integer post_id,
    ...
    @GetMapping("/{user_id}/user/valorations")
     ResponseEntity<?> getAllValorationsByUser(@PathVariable Integer user_id);
