...
public class ProductControllerValidationIntegrationTest {
    ...
    /*
     * Test de integración del endpoint /products
     * Verifica que retorne error si el product_id es null
     */
    @Test
    void createPost_shouldReturnErrorWhenProductIdIsNull() throws Exception {
        ProductDto productDto = new ProductDto(null, "ValidName", "ValidType", "ValidBrand", "ValidColor", "ValidNotes");
    ...
    void createPost_shouldReturnErrorWhenProductNameHasSpecialCharacters() throws Exception {
        ProductDto productDto = new ProductDto(1, "Invalid@Name", "ValidType", "ValidBrand", "ValidColor", "ValidNotes");
        PostDto postDto = new PostDto(1, LocalDate.now(), productDto, 1, 500.0);
    ...
    void createPost_shouldReturnErrorWhenTypeIsTooLong() throws Exception {
        ProductDto productDto = new ProductDto(1, "ValidName", "TypeTooLongOverFifteen", "ValidBrand", "ValidColor", "ValidNotes");
        PostDto postDto = new PostDto(1, LocalDate.now(), productDto, 1, 500.0);
    ...
    void createPost_shouldReturnErrorWhenBrandHasSpecialCharacters() throws Exception {
        ProductDto productDto = new ProductDto(1, "ValidName", "ValidType", "Invalid#Brand", "ValidColor", "ValidNotes");
        PostDto postDto = new PostDto(1, LocalDate.now(), productDto, 1, 500.0);
    ...
    void createPost_shouldReturnErrorWhenNotesAreTooLong() throws Exception {
        String longNotes = "Este texto es muy largo y va a superar los ochenta caracteres permitidos para el campo notes.";
        ProductDto productDto = new ProductDto(1, "ValidName", "ValidType", "ValidBrand", "ValidColor", longNotes);
        PostDto postDto = new PostDto(1, LocalDate.now(), productDto, 1, 500.0);
    ...
    void createPost_shouldCreateSuccessfullyWithValidData() throws Exception {
        ProductDto productDto = new ProductDto(1, "ValidName", "ValidType", "ValidBrand", "ValidColor", "ValidNotes");
        PostDto postDto = new PostDto(1, LocalDate.now(), productDto, 1, 500.0);
    ...
    void createPost_shouldReturnErrorWhenColorHasSpecialCharacters() throws Exception {
        ProductDto productDto = new ProductDto(1, "ValidName", "ValidType", "ValidBrand", "Invalid@Color", "ValidNotes");
        PostDto postDto = new PostDto(1, LocalDate.now(), productDto, 1, 500.0);
    ...
    /*
     * Test de integración del endpoint /products
     * Verifica que retorne error si el price es negativo
     */
    @Test
